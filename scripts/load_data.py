...
def load_images_from_directory(data_dir, img_size=(128, 128)):
    ...
    for class_name in class_names:
        ...
        for img_file in os.listdir(class_dir):
            ...
            # Check if it's an image file (optional, to avoid errors)
...
def load_train_test_data(data_dir, img_size=(128, 128)):
